...
#define BGFX_PLATFORM_SUPPORTS_GLSL \
...
#define BGFX_EMBEDDED_SHADER_DXBC(_renderer, _name) \
    {_renderer,                                     \
     BX_CONCATENATE (_name, _dx11),                 \
     BX_COUNTOF (BX_CONCATENATE (_name, _dx11))},
...
#define BGFX_EMBEDDED_SHADER_ESSL(_renderer, _name) \
    {_renderer,                                     \
     BX_CONCATENATE (_name, _essl),                 \
     BX_COUNTOF (BX_CONCATENATE (_name, _essl))},
...
#define BGFX_EMBEDDED_SHADER_GLSL(_renderer, _name) \
    {_renderer, BX_CONCATENATE (_name, _440), BX_COUNTOF (BX_CONCATENATE (_name, _440))},
...
#define BGFX_EMBEDDED_SHADER(_name)                                                      \
    {                                                                                    \
        ...
        {                                                                                \
            ...
            BGFX_EMBEDDED_SHADER_SPIRV (                                                 \
                bgfx::RendererType::Vulkan,                                              \
                _name) /*BGFX_EMBEDDED_SHADER_SPIRV(bgfx::RendererType::WebGPU, _name)*/ \
...
///
ShaderHandle createEmbeddedShader (const bgfx::EmbeddedShader *_es,
