...
void bgfxHandle_t::init ()
{
    ...
    m_d->backgroundShader = loadBgfxProgram ("background");
    m_d->maskBackgroundShader = loadBgfxProgram ("maskBackground");
    m_d->flatShader = loadBgfxProgram ("flat");
    m_d->noiseShader = loadBgfxProgram ("noise");
    m_d->rampShader = loadBgfxProgram ("ramp");
}
